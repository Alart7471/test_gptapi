...
// src/lib/util.ts
function sdkPostMessage(api2, method_id, msg) {
  return new Promise((resolve, reject) => {
    ...
    parent.postMessage(data2, "*");
  });
}
function gigaSdkPostMessage(api2, method_id, msg) {
  return new Promise((resolve, reject) => {
    const seq = generateUUID();
    window.addEventListener("message", (res) => {
      if (res && res.data && res.data.__seq && res.data.__seq === seq && res.data.__sdk === "giga") {
        resolve(res.data);
      }
    }, false);
    const data2 = {
...
var platform = {
  init() {
    return new Promise((resolve) => {
      sdkPostMessage("platform", "init", "investec-web-platform").then((res) => {
        if (res.data === void 0) {
  ...
  initSession() {
    (0, import_rxjs.fromEvent)(document, "click").subscribe(() => {
      sdkPostMessage("platform", "session", void 0);
    });
  },
  initPreLoginSession(sessionTime, functionOnLogout) {
    sdkPostMessage("platform", "preSession", sessionTime);
    (0, import_rxjs.fromEvent)(document, "click").subscribe(() => {
      sdkPostMessage("platform", "session", void 0);
    });
    sdkPostMessage("platform", "preSessionLogoutFunction", void 0).then((res) => {
      if (functionOnLogout !== void 0) {
        functionOnLogout();
      } else {
        sdkPostMessage("platform", "logout", void 0);
      }
    });
  },
  getPlatformToken() {
    return new Promise((resolve, reject) => {
      sdkPostMessage("platform", "generatePlatformToken", void 0).then((res) => {
        resolve(res.data);
      }).catch((err) => {
        reject(err);
      });
  ...
  isWebOrMobile() {
    return new Promise((resolve, reject) => {
      sdkPostMessage("platform", "isWebOrMobile", void 0).then((res) => {
        resolve(res.data);
      }).catch((err) => {
        reject(err);
      });
  ...
  previousPageUrl() {
    return new Promise((resolve, reject) => {
      sdkPostMessage("platform", "previousPageUrl", void 0).then((res) => {
        resolve(res.data);
      }).catch((err) => {
        reject(err);
      });
  ...
  preFetchData(authRes) {
    sdkPostMessage("platform", "preFetchData", authRes);
  },
  reset() {
    sdkPostMessage("platform", "reset", void 0);
  },
  setBrowserTile(title) {
    sdkPostMessage("platform", "browserTitle", title);
  },
  navigateUrl(url, target) {
    sdkPostMessage("platform", "navigateUrl", { url, target });
  },
  navigateAppId(id, target) {
    sdkPostMessage("platform", "navigateAppId", { id, target });
  },
  printDocument(data2) {
    sdkPostMessage("platform", "printDocument", data2);
  },
  updateUrl(url) {
    sdkPostMessage("platform", "updateUrl", { url });
  },
  loggedInSuccessfully(authRes) {
  ...
  determineJourneyAfterLogin() {
    sdkPostMessage("platform", "determineJourneyAfterLogin", void 0);
  },
  updateMenuRegion(region) {
    sdkPostMessage("platform", "updateMenuRegion", region);
  },
  interactions: {
    update(interactions) {
      return new Promise((resolve, reject) => {
        sdkPostMessage("platform", "interactions.update", interactions).then((res) => {
          resolve(res.data);
        }).catch((err) => {
          reject(err);
        });
  ...
  trackAdobeAnalytics(event, action) {
    sdkPostMessage("platform", "adobe.analytics", { event, action });
  },
  logout() {
    sdkPostMessage("platform", "logout", void 0);
  }
...
var runningStreams = { portfolioStream: false, profileStream: false };
var data = {
  getAllUserContext() {
    return new Promise((resolve, reject) => {
      sdkPostMessage("data", "getAllUserContext", void 0).then((res) => {
        resolve(res.data);
      }).catch((err) => {
        reject(err);
      });
  ...
  getUserUID() {
    return new Promise((resolve, reject) => {
      sdkPostMessage("data", "getUserUID", void 0).then((res) => {
        resolve(res.data);
      }).catch((err) => {
        reject(err);
      });
  ...
  getClientBasicDetails() {
    return new Promise((resolve, reject) => {
      sdkPostMessage("data", "getClientBasicDetails", void 0).then((res) => {
        resolve(res.data);
      }).catch((err) => {
        reject(err);
      });
  ...
  getPersonalisationOffers(id, template, data2) {
    sdkPostMessage("data", "getPersonalisationOffers", { template, data: data2 }).then((res) => {
  ...
  getClientTypes() {
    return new Promise((resolve, reject) => {
      sdkPostMessage("data", "getClientTypes", void 0).then((res) => {
        resolve(res.data);
      }).catch((err) => {
        reject(err);
      });
  ...
  getSelectedProfile() {
    const $selectedProfile = new import_rxjs2.Subject();
    const abortController = new AbortController();
    function getSelectedZaProfileFromEvents(id, data2) {
    ...
    sdkPostMessage("data", "getSelectedProfile", void 0).then(() => {
  ...
  portfolio: {
    getState() {
      return new Promise((resolve, reject) => {
        sdkPostMessage("data", "portfolio.getState", void 0).then((res) => {
          resolve(res.data);
        }).catch((err) => {
          reject(err);
        });
    ...
    excludeFromTotal(payload) {
      return new Promise((resolve) => {
        sdkPostMessage("data", "portfolio.updatePortfolioExcludes", payload).then((res) => {
          resolve(res.data);
        });
      });
    },
    getAllPortfolios(currency, selectedProfile) {
      const $portfolio = new import_rxjs2.Subject();
      let abortController = new AbortController();
      function getPortfoliosFormEvents(id, data2) {
      ...
      sdkPostMessage("data", "portfolio.getAllPortfolios", { currency, selectedProfile }).then(() => {
        abortController.abort();
        runningStreams.portfolioStream = false;
      });
      return $portfolio;
    },
    getPrivateBankZAPortfolio(currency, selectedProfile) {
      return new Promise((resolve, reject) => {
        sdkPostMessage("data", "portfolio.getPrivateBankZAPortfolio", { currency, selectedProfile }).then((res) => {
          resolve(res.data);
        }).catch((err) => {
          reject(err);
        });
    ...
    getPrivateBankUKPortfolio(currency) {
      return new Promise((resolve, reject) => {
        sdkPostMessage("data", "portfolio.getPrivateBankUKPortfolio", { currency, selectedProfile: void 0 }).then((res) => {
          resolve(res.data);
        }).catch((err) => {
          reject(err);
        });
    ...
    getPrivateBankUKMortgagesPortfolio(currency) {
      return new Promise((resolve, reject) => {
        sdkPostMessage("data", "portfolio.getPrivateBankUKMortgagesPortfolio", { currency, selectedProfile: void 0 }).then((res) => {
          resolve(res.data);
        }).catch((err) => {
          reject(err);
        });
    ...
    getPrivateBankCIPortfolio(currency) {
      return new Promise((resolve, reject) => {
        sdkPostMessage("data", "portfolio.getPrivateBankCIPortfolio", { currency, selectedProfile: void 0 }).then((res) => {
          resolve(res.data);
        }).catch((err) => {
          reject(err);
        });
    ...
    getPrivateBankMUPortfolio(currency) {
      return new Promise((resolve, reject) => {
        sdkPostMessage("data", "portfolio.getPrivateBankMUPortfolio", { currency, selectedProfile: void 0 }).then((res) => {
          resolve(res.data);
        }).catch((err) => {
          reject(err);
        });
    ...
    getWealthAndInvestmentZAPortfolio(currency) {
      return new Promise((resolve, reject) => {
        sdkPostMessage("data", "portfolio.getWealthAndInvestmentZAPortfolio", { currency, selectedProfile: void 0 }).then((res) => {
          resolve(res.data);
        }).catch((err) => {
          reject(err);
        });
    ...
    getWealthAndInvestmentUKPortfolio(currency) {
      return new Promise((resolve, reject) => {
        sdkPostMessage("data", "portfolio.getWealthAndInvestmentUKPortfolio", { currency, selectedProfile: void 0 }).then((res) => {
          resolve(res.data);
        }).catch((err) => {
          reject(err);
        });
    ...
    getWealthAndInvestmentGUPortfolio(currency) {
      return new Promise((resolve, reject) => {
        sdkPostMessage("data", "portfolio.getWealthAndInvestmentGUPortfolio", { currency, selectedProfile: void 0 }).then((res) => {
          resolve(res.data);
        }).catch((err) => {
          reject(err);
        });
    ...
    getWealthAndInvestmentClickPortfolio(currency) {
      return new Promise((resolve, reject) => {
        sdkPostMessage("data", "portfolio.getWealthAndInvestmentClickPortfolio", { currency, selectedProfile: void 0 }).then((res) => {
          resolve(res.data);
        }).catch((err) => {
          reject(err);
        });
    ...
    getWealthAndInvestmentCIPortfolio(currency) {
      return new Promise((resolve, reject) => {
        sdkPostMessage("data", "portfolio.getWealthAndInvestmentCIPortfolio", { currency, selectedProfile: void 0 }).then((res) => {
          resolve(res.data);
        }).catch((err) => {
          reject(err);
        });
    ...
    getAllNonInvestecAccounts(currency) {
      return new Promise((resolve, reject) => {
        sdkPostMessage("data", "portfolio.getAllNonInvestecAccounts", { currency, selectedProfile: void 0 }).then((res) => {
          resolve(res.data);
        }).catch((err) => {
          reject(err);
        });
  ...
  lookups: {
    bank: {
      sa: {
        list() {
          return new Promise((resolve, reject) => {
            sdkPostMessage("data", "lookups.bank.sa", void 0).then((res) => {
              resolve(res.data);
            }).catch((err) => {
              reject(err);
            });
    ...
    client: {
      sa: {
        list() {
          return new Promise((resolve, reject) => {
            sdkPostMessage("data", "lookups.client.sa", void 0).then((res) => {
              resolve(res.data);
            }).catch((err) => {
              reject(err);
            });
...
// src/lib/api/private-client/pbsa/transactions.ts
var transactions_sa = {
  /**
...
// src/lib/api/private-client/pbsa/client.ts
var client_sa = {
  /**
   * Get client details
   */
  get() {
    return new Promise((resolve, reject) => {
      sdkPostMessage("pbsa", "client.get", void 0).then((res) => {
        resolve(res.data);
      }).catch((err) => {
        reject(err);
      });
...
// src/lib/api/private-client/pbsa/account.ts
var account_sa = {
  /**
   * List accounts
   */
  list() {
    return new Promise((resolve, reject) => {
      sdkPostMessage("pbsa", "account.list", void 0).then((res) => {
        resolve(res.data);
      }).catch((err) => {
        reject(err);
      });
...
// src/lib/api/private-client/pbsa/cards.ts
var cards_sa = {
  /**
   *
  ...
  block(cardData) {
    return new Promise((resolve, reject) => {
      sdkPostMessage("pbsa", "cards.block", cardData).then((res) => {
        resolve(res.data);
      }).catch((err) => {
        reject(err);
      });
   ...
   * @param cardData
   */
  getFullCardDetail(cardData) {
    return new Promise((resolve, reject) => {
      sdkPostMessage("pbsa", "cards.fullDetail", cardData).then((res) => {
        resolve(res.data);
      }).catch((err) => {
        reject(err);
      });
...
// src/lib/api/private-client/pbsa/beneficiaries.ts
var beneficiaries_sa = {
  list() {
    return new Promise((resolve, reject) => {
      sdkPostMessage("pbsa", "beneficiaries.list", void 0).then((res) => {
        resolve(res.data);
      }).catch((err) => {
        reject(err);
      });
...
// src/lib/api/private-client/pbsa/payments.ts
var payments_sa = {
  beneficiary(paymentData) {
    return new Promise((resolve, reject) => {
      sdkPostMessage(
        "pbsa",
...
// src/lib/api/private-client/pbsa/rates.ts
var rates_sa = {
  /**
   * Get rate details
   */
  get() {
    return new Promise((resolve, reject) => {
      sdkPostMessage("pbsa", "rates.get", void 0).then((res) => {
        resolve(res.data);
      }).catch((err) => {
        reject(err);
      });
...
// src/lib/api/private-client/pbsa/rewards.ts
var rewards_sa = {
  getLanding(accountNumberForRequests) {
    return new Promise((resolve, reject) => {
      sdkPostMessage("pbsa", "rewards.landing", {
        accountNumberForRequests
      }).then((res) => {
        resolve(res.data);
      }).catch((err) => {
        reject(err);
  ...
  getPartners(accountNumberForRequests) {
    return new Promise((resolve, reject) => {
  ...
  getPartnerCategories() {
    return new Promise((resolve, reject) => {
      sdkPostMessage("pbsa", "rewards.partnerCategories", void 0).then((res) => {
        resolve(res.data);
      }).catch((err) => {
        reject(err);
      });
  ...
  transfer(data2) {
    return new Promise((resolve, reject) => {
      sdkPostMessage("pbsa", "rewards.transfer", {
        ...
        transferPoints: data2.transferPoints
      }).then((res) => {
        resolve(res.data);
      }).catch((err) => {
        reject(err);
  ...
  getUnitTrustCategories() {
    return new Promise((resolve, reject) => {
      sdkPostMessage("pbsa", "rewards.unitTrustCategories", void 0).then((res) => {
        resolve(res.data);
      }).catch((err) => {
        reject(err);
      });
  ...
  getUnitTrusts() {
    return new Promise((resolve, reject) => {
      sdkPostMessage("pbsa", "rewards.unitTrusts", void 0).then((res) => {
        resolve(res.data);
      }).catch((err) => {
        reject(err);
      });
  ...
  getCalculatorSolutions(accountNumberForRequests) {
    return new Promise((resolve, reject) => {
  ...
  getTransactionTypes() {
    return new Promise((resolve, reject) => {
      sdkPostMessage("pbsa", "rewards.transactionTypes", void 0).then((res) => {
        resolve(res.data);
      }).catch((err) => {
        reject(err);
      });
  ...
  getTransactions(accountNumberForRequests, transactionTypeId) {
    return new Promise((resolve, reject) => {
...
// src/lib/api/private-client/pbuk/client.ts
var client_uk = {
  /**
   * Get client details
   */
  get() {
    return new Promise((resolve, reject) => {
      sdkPostMessage("pbuk", "client.get", void 0).then((res) => {
        resolve(res.data);
      }).catch((err) => {
        reject(err);
      });
...
// src/lib/api/private-client/pbuk/transactions.ts
var transactions_uk = {
  /**
   * List transactions
   * @param accountId
   ...
   * @param endDate
   */
  list(accountId, startDate, endDate) {
    return new Promise((resolve, reject) => {
      sdkPostMessage(
        "pbuk",
        "transactions.list",
...
// src/lib/api/private-client/pbuk/account.ts
var account_uk = {
  /**
   * List accounts
   */
  list() {
    return new Promise((resolve, reject) => {
      sdkPostMessage("pbuk", "account.list", void 0).then((res) => {
        resolve(res.data);
      }).catch((err) => {
        reject(err);
      });
...
// src/lib/api/private-client/pbuk/beneficiaries.ts
var beneficiaries_uk = {
  list() {
    return new Promise((resolve, reject) => {
      sdkPostMessage("pbuk", "beneficiaries.list", void 0).then((res) => {
        resolve(res.data);
      }).catch((err) => {
        reject(err);
      });
...
// src/lib/api/private-client/pbuk/payments.ts
var payments_uk = {
  beneficiary(paymentData) {
    return new Promise((resolve, reject) => {
      sdkPostMessage(
...
// src/lib/api/private-client/wisa/transactions.ts
var transactions_wisa = {
  /**
   * List transactions
   * @param accounts
   * @param startDate
   ...
   * @param isAllAccounts
   */
  list(accounts, startDate, endDate, instrumentCode, categoryCodes, isAllAccounts) {
    return new Promise((resolve, reject) => {
      sdkPostMessage(
        "wisa",
        "transactions.list",
...
// src/lib/api/private-client/wisa/account.ts
var account_wisa = {
  /**
   * List accounts
   */
  list() {
    return new Promise((resolve, reject) => {
      sdkPostMessage("wisa", "account.list", void 0).then((res) => {
        resolve(res.data);
      }).catch((err) => {
        reject(err);
      });
...
// src/lib/api/private-client/wisa/holdings.ts
var holdings_wisa = {
  /**
   * List holdings
   */
  list(accounts, referenceCurrencyCode, referenceDate) {
    return new Promise((resolve, reject) => {
...
// src/lib/api/private-client/wisa/market-data.ts
var market_data_wisa = {
  indices: {
    international: {
      get() {
        return new Promise((resolve, reject) => {
  ...
  currency: {
    get() {
      return new Promise((resolve, reject) => {
        sdkPostMessage("wisa", "currency.get", void 0).then((res) => {
          resolve(res.data);
        }).catch((err) => {
          reject(err);
        });
    ...
    history(ID, FromDate, ToDate) {
      return new Promise((resolve, reject) => {
        sdkPostMessage("wisa", "currency.history", { id: ID, fromDate: FromDate, toDate: ToDate }).then((res) => {
          resolve(res.data);
        }).catch((err) => {
          reject(err);
        });
  ...
  commodity: {
    get() {
      return new Promise((resolve, reject) => {
        sdkPostMessage("wisa", "commodity.get", void 0).then((res) => {
          resolve(res.data);
        }).catch((err) => {
          reject(err);
        });
  ...
  dividends: {
    get() {
      return new Promise((resolve, reject) => {
        sdkPostMessage("wisa", "dividends.get", void 0).then((res) => {
          resolve(res.data);
        }).catch((err) => {
          reject(err);
        });
...
// src/lib/api/private-client/wiuk/account.ts
var account_wiuk = {
  /**
   * List accounts
   * @param referenceDate
   ...
   */
  list(referenceDate, referenceCurrencyCode) {
    return new Promise((resolve, reject) => {
      sdkPostMessage(
        "wiuk",
        "account.list",
...
// src/lib/api/private-client/wiuk/asset-allocation.ts
var asset_allocation_wiuk = {
  /**
   ...
   * @param account
   */
  get(referenceDate, referenceCurrencyCode, account) {
    return new Promise((resolve, reject) => {
      sdkPostMessage(
        "wiuk",
        "assetAllocation.get",
...
// src/lib/api/private-client/wiuk/transactions.ts
var transactions_wiuk = {
  /**
   * List transactions
   * @param startDate
   * @param endDate
   ...
   * @param account
   */
  list(startDate, endDate, referenceCurrencyCode, statementType, account) {
    return new Promise((resolve, reject) => {
      sdkPostMessage(
        "wiuk",
        "transactions.list",
...
// src/lib/api/private-client/wiuk/holdings.ts
var holdings_wiuk = {
  /**
   * List holdings
   * @param referenceDate
   ...
   * @param account
   */
  list(referenceDate, referenceCurrencyCode, account) {
    return new Promise((resolve, reject) => {
      sdkPostMessage(
        "wiuk",
        "holdings.list",
...
// src/lib/api/private-client/pfm/account.ts
var account_pfm = {
  list: {
    /**
     * List accounts
    ...
    all() {
      return new Promise((resolve, reject) => {
        sdkPostMessage("pfm", "account.list.all", void 0).then((res) => {
          resolve(res.data);
        }).catch((err) => {
          reject(err);
        });
  ...
  remove(accountId) {
    return new Promise((resolve, reject) => {
      sdkPostMessage("pfm", "account.remove", accountId).then((res) => {
        resolve(res.data);
      }).catch((err) => {
        reject(err);
      });
...
// src/lib/api/private-client/programmable-banking/programmable-banking.ts
var programmable_banking = {
  oauth: {
    get() {
      return new Promise((resolve, reject) => {
        sdkPostMessage(
  ...
  code: {
     ...
     * @param cardKey
     */
    getPublished(accountNumber, cardKey) {
      return new Promise((resolve, reject) => {
        sdkPostMessage(
          "programmable",
     ...
     * @param code
     */
    save(accountNumber, cardKey, code) {
      return new Promise((resolve, reject) => {
        sdkPostMessage(
          "programmable",
     ...
     * @param code
     */
    publish: function(accountNumber, cardKey, code, codeId) {
      return new Promise((resolve, reject) => {
        sdkPostMessage(
          "programmable",
  ...
  env: {
     ...
     * @param variables
     */
    save(accountNumber, cardKey, variables) {
      return new Promise((resolve, reject) => {
        sdkPostMessage(
          "programmable",
          "cards.saveEnvVars",
...
// src/lib/api/private-client/pbuk/cards.ts
var cards_uk = {
  /**
   *
   * @param account_number
...
// src/lib/native-mobile/platfrom-mobile.ts
var MobilePlatform = {
  wallet: {
    open() {
      return new Promise((resolve, reject) => {
        sdkPostMessage("mobilePlatform", "wallet.open", void 0).then((res) => {
          resolve(res.data);
        }).catch((err) => {
          reject(err);
        });
...
var ai = {
  gigaChat: {
    open() {
      sdkPostMessage("platform", "interactions.update", { leftApp: { show: true, src: "https://giga-widget.pages.dev/", width: "400" } });
    },
    close() {
      sdkPostMessage("platform", "interactions.update", { leftApp: { show: false, src: "", width: "0" } });
    }
  },
  context: {
    add(context) {
      return new Promise((resolve) => {
        gigaSdkPostMessage("ai", "context.add", context).then((res) => {
          resolve(res);
        }).catch((err) => {
          resolve(err);
        });
  ...
  message: {
    add(message) {
      return new Promise((resolve) => {
        gigaSdkPostMessage("ai", "message.add", message).then((res) => {
          resolve(res);
        }).catch((err) => {
          resolve(err);
        });
